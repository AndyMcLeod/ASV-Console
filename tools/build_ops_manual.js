...
c.push(P("RANGE. The traffic card has a range control in km. It is a FILTER on an area the service has already collected, not a new subscription — so widening it is instant, and it will not go beyond what was collected (the control snaps back if you ask for more). The row beside it reads something like “3 of 6 in 150 km”, so you can tell an empty sea from a view you narrowed yourself. ON A GREAT LAKE THE CONTROL DOES NOT APPLY: the area is the whole lake and every contact is shown, and the card says so rather than appearing to ignore you."));
