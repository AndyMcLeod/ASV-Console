...
turn-water hold is closed (`a548c14`). **37 regression suites / 583 assertions**, derived
...
**THIRTY-SEVEN REGRESSION SUITES (583 assertions), all run by the pre-commit hook** (`.githooks/pre-commit`;
