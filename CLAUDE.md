...
## ⇒ START HERE (handoff refreshed 2026-09-20 — **ANDY'S FOUR ARE ALL SHIPPED. ITEM 4 STAGE 1, THE LAUNCH GRANT, IS COMPLETE AND LIVE on the branch `wip/launch-grant-stage1`** — read the first block, it says what is NOT yet on master)
